...
class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests()
                ...
                .antMatchers("/", "/login/**", "/support/**","/feedback/**","/volunteer/**", "/register", "/user/**", "/waiting/**","/home","/admin/**","/admin/block/**", "/admin/users/admin/block/**" ,"/military/**", "/admin/approve/**", "/admin/block/**", "/registration", "/user","/register/save", "/save", "/request", "/request/save", "/fundraising", "/fundraising/save", "/statusFundraising","/user/**").permitAll()
