...
import com.nameless.volunteerproject.configuration.CustomLoginSuccessHandler;
import com.nameless.volunteerproject.models.User;
import com.nameless.volunteerproject.services.CustomUserDetailsService;
...
class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests()
                ...
                .antMatchers("/", "/login", "/register", "/home","/admin", "/admin/approve/**", "/admin/block/**", "/registration", "/user","/register/save", "/save", "/request", "/request/save", "/fundraising", "/fundraising/save", "/statusFundraising","/user/**").permitAll()
